...
public class 스트림연습 {
    public static void main(String[] args) {
        ...
        stream.filter(t -> t.getYear() >= 2015).forEach(item -> System.out.println(item));
        ...
        //stream = movies.stream();
        //stream.sorted((o1, o2) -> o1.getYear()-o2.getYear()).forEach(item->System.out.println(item));
